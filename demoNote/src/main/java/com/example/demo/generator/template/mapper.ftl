...
<mapper namespace="com.example.demo.module.${moduleName}.mapper.${entityName}Mapper">
	...
	<select id="pageList" resultType="com.example.demo.module.${moduleName}.dto.${entityName}DTO">
		select *
		<include refid="from"/>

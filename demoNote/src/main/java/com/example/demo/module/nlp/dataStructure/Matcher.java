package com.example.demo.module.nlp.dataStructure;
...
public abstract class Matcher {
     ...
     * 词典文件所在目录
     */
    private static String  dicDir = "D:\\workspace\\own\\mygithub\\MyNote\\demoNote\\src\\main\\java\\com\\example\\demo\\module\\nlp\\dic\\";
    ...
    /**
     * 将词典文件中的所有词读取并根据实现不同封装成TrieNode或TernaryTrieNode对象，分别对应AC自动机和三元查找树
     */
    public void create() {

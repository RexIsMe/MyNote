package com.rex.diyapp.client;

import com.rex.diyapp.entity.*;
import com.rex.diyapp.exception.DingTalkException;
import com.rex.diyapp.type.HideAvatarType;
import com.rex.diyapp.type.ResponseCodeType;
...
public class DingTalkRobotClient {
    ...
    public DingTalkResponse sendMessageByURL(URI url, BaseMessage message) {
        ...
        HttpEntity<Map> entity = new HttpEntity<Map>(message.toMessageMap(), headers);

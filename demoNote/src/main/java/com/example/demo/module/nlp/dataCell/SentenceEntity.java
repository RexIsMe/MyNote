package com.example.demo.module.nlp.dataCell;
...
public class SentenceEntity {
    ...
    /**
     * 根据待分词字符串sentence创建一个SentenceEntity对象
     * SentenceEntity对象包含一个tokenSet引用对象，该tokenSet对象是一个数组，长度为sentence的 长度+2；且该tokenSet的头尾两个对象由自己设置
     * @param sentence
     */
